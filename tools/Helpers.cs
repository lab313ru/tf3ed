...
namespace Helpers
{
    public static class Helper
    {
        ...
        public static ushort PeekWord(this MemoryStream stream)
        {
        ...
        public static uint PeekLong(this MemoryStream stream)
        {
            long pos = stream.Position;
        ...
        public static void WriteWord(this MemoryStream stream, ushort value)
        {
            byte[] array = new byte[2];
        ...
        public static void WriteLong(this MemoryStream stream, uint value)
        {
            byte[] array = new byte[4];
